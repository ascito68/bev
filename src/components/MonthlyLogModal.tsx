...
export default function MonthlyLogModal({ onAdd, onClose }: Props) {
  ...
  const handleSubmit = () => {
    if (!isValid) return
    onAdd([{ date: `${monthYear}-01`, km: kmVal, vehicleType: 'phev', entryType: 'monthly', electricKm: evVal, hybridKm: hybVal }])
    onClose()
  }
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm">
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-gray-800">Dati mensili PHEV</h2>
          </div>
